...
Get-ChocolateyUnzip -FileFullPath "$toolsDir\install-tl.zip" -Destination "$toolsDirNew" -PackageName "texlive"
Move-Item -Path "$toolsDirNew\install-tl-*\*" -Destination "$toolsDirNew" -Force 
